...
namespace Tyuiu.ElizarovKI.Sprint4.Task1.V13
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Дан одномерный целочисленный массив элементов заполненный значениями    *");
            Console.WriteLine("***************************************************************************");
            ...
            {
                Console.WriteLine("Введите значение " + i + " эемента массива: ");
